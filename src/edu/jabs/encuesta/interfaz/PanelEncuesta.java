...
public class PanelEncuesta extends JPanel implements ActionListener
{
    ...
    public PanelEncuesta( InterfazEncuesta pPrincipal )
    {
        ...
        panelConsulta.setBorder( new CompoundBorder( new EmptyBorder( 3, 5, 3, 5 ), new TitledBorder( "Consulta por sector demogr�fico" ) ) );
        ...
        panelEstadisticasGenerales.setBorder( new CompoundBorder( new EmptyBorder( 3, 5, 3, 5 ), new TitledBorder( "Estad�sticas generales" ) ) );
